...
function puca_tbay_customize_control_js() {
	wp_enqueue_script( 'color-scheme-control', PUCA_SCRIPTS . '/color-scheme-control' . PUCA_MIN_JS . '.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20141216', true );
...
function puca_tbay_customize_preview_js() {
	wp_enqueue_script( 'puca-customize-preview', PUCA_SCRIPTS . '/customize-preview' . PUCA_MIN_JS . '.js', array( 'customize-preview' ), '20141216', true );
}
