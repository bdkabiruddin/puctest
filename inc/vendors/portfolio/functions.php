...
if ( !function_exists('puca_tbay_portfolio_scripts') ) {
    function puca_tbay_portfolio_scripts() {
        ...
        if( isset($post->post_type) && $post->post_type == 'project' ) { 
            ...
            wp_register_script( 'jquery-magnific-popup', PUCA_SCRIPTS . '/jquery.magnific-popup' . PUCA_MIN_JS . '.js', array( ), '1.0.0', true );             
            wp_register_script( 'jquery-shuffle', PUCA_SCRIPTS . '/jquery.shuffle' . PUCA_MIN_JS . '.js', array( ), '1.0.0', true );             
