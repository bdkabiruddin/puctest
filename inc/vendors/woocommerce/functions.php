...
if ( !function_exists('puca_tbay_woocommerce_enqueue_styles') ) {
    function puca_tbay_woocommerce_enqueue_styles() {
        ...
        wp_register_script( 'jquery-onepagenav', PUCA_SCRIPTS . '/jquery.onepagenav' . PUCA_MIN_JS . '.js', array( 'jquery' ), '3.0.0', true ); 
...
if ( !function_exists('puca_tbay_woocommerce_display_modes') ) {
    ...
    add_action( 'woocommerce_before_shop_loop', 'puca_tbay_woocommerce_display_modes' , 2 );
}
...
if ( !function_exists('puca_tbay_woocommerce_get_display_mode') ) {
    function puca_tbay_woocommerce_get_display_mode() {
        ...
        if ( isset($_COOKIE['puca_woo_mode']) && ($_COOKIE['puca_woo_mode'] == 'list' || $_COOKIE['puca_woo_mode'] == 'grid') ) {
            $woo_mode = $_COOKIE['puca_woo_mode'];
        }
        return $woo_mode;
    }
}
            ...
            if( isset($product_archive_layout) ) {
                switch ( $product_archive_layout ) {
                    ...
                    case 'shop-right':
                        ...
                        break;                
                    case 'shop-des-left':
                        $configs['left_descreption'] = array( 'sidebar'  => $left, 'class' => 'col-xs-12 col-md-12 col-lg-3'  );
                        ...
                        break;                
                    case 'shop-des-right':
                        $configs['right_descreption'] = array( 'sidebar'  => $right, 'class' => 'col-xs-12 col-md-12 col-lg-3'  );
                        $configs['main_descreption'] = array( 'class'    => 'col-xs-12 col-md-12 col-lg-9' );
                        $configs['main'] = array( 'class' => 'archive-full' );
                        $configs['descreption'] = true;
                        $configs['breadscrumb_class'] = 'shop-des';
