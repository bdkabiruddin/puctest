                    ...
                    <tr id="yith-wcwl-row-<?php echo esc_attr($item['prod_id']); ?>" data-row-id="<?php echo esc_attr($item['prod_id']); ?>">
                        ...
                        <?php if( $show_price ) : ?>
                            <td class="product-price">
                                <?php echo ($product->get_price()) ? $product->get_price_html() : apply_filters( 'yith_free_text', esc_html__( 'Free!', 'puca' ) ); ?>
                            </td>
                        <?php endif ?>

                        <?php if( $show_stock_status ) : ?>
                            <td class="product-stock-status">
                                <?php echo ($stock_status == 'out-of-stock') ? '<span class="wishlist-out-of-stock">' . esc_html__( 'Out of Stock', 'puca' ) . '</span>' : '<span class="wishlist-in-stock">' . esc_html__( 'In Stock', 'puca' ) . '</span>'; ?>
                            </td>
                        <?php endif ?>
